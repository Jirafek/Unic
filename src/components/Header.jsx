...
const Header = () => {
    return (
        <Fragment>
          <header className='fixed top-0 left-0 z-10 w-full bg-[#F3F7FF] h-[120px] flex items-center border-b border-[#E0E0E0] text-[0.688rem]'>
            ...
            <div className='flex items-center gap-x-5'>
                <a className='cursor-pointer flex items-center ml-[3.125rem] gap-x-[0.938rem]' href='tel:+74954812221'>
                    ...
                    <p className='w-[17rem] text-[#3C517B] font-normal'>Приемная комиссия: +7 (495) 481-22-21</p>
                </a>
            ...
            <div className='flex h-[3.125rem] ml-[1.875rem]'>
