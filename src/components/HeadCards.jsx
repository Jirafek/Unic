        ...
        let newArr = cards_data.map((el, i) => {
            return (
                ...
                className="relative h-[12.5rem] w-[20.625rem] text-[0.688rem] flex flex-col justify-end duration-500 hover:-translate-y-[10px]">
                    ...
                    <div className='h-[11.25rem] w-full bg-[#F3F7FF] rounded-[5px] align-bottom pt-[3.125rem] pl-[1.875rem]'>
                        ...
                        <button className='bg-white text-[0.6875rem] font-bold flex h-[1.875rem] group'>
                            ...
                            <div className='w-10 h-full flex items-center justify-center border border-[#2B73FF] rounded-r-[3px] '>
                                <img className='w-[15px] duration-500 bg-white group-hover:translate-x-[5px]' src="/img/arrow.png" alt="" />
                            </div>
                        </button>
                    </div>
                </div>
